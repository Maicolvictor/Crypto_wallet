    ...
    show_spinner("Creating coins") do
      coins = [
        ...
        },
        {
          description: "Iota",
          acronym: "IOT",
          url_image: "https://static-00.iconduck.com/assets.00/iota-cryptocurrency-icon-2048x2029-s97fnre3.png",
          mining_type: MiningType.all.sample
        },
        {
          description: "ZCash",
      ...
      coins.each do |coin|
        Coin.find_or_create_by(coin) rescue ActiveRecord::RecordInvalid
      end
    end
  end
...
task add_mining_types: :environment do
  show_spinner("Cadastrando tipos de mineração...") do
    ...
    mining_types.each do |mining_type|
      MiningType.find_or_create_by(mining_type) rescue ActiveRecord::RecordInvalid
    end
  end
end
